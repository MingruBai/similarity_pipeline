...
//  mexPrintf("Setup off-screen mesa's binding\n");
...
//  mexPrintf("Clear previous settings\n");
  ...
  //mexPrintf("step2: setup basic opengl setting\n");
...
//  mexPrintf("Set projection matrx\n");
